      ...
      appBar: AppBar(
        ...
        actions: [
          TextButton(
            onPressed: () {
              if(isVisible){
                Map<String, dynamic> map = {'emoji': editcontroller.emoji,
                  'content': editcontroller.content,};
                print(map);
                editcontroller.addDiaryToDB(
                    map
                );
              }
              else null;
              }, child: Text("저장", style: TextStyle(color: isVisible==true? Colors.black : Colors.grey),),
